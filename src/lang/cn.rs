...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
		...
		("How to get Android input permission?", "如何获取 众通宝的网络加密？"),
        ...
        ("android_start_service_tip", "点击启动 众通宝按钮，即可接入 众通宝"),
        ...
        ("selinux_tip", "SELinux 处于启用状态， 众通宝 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
